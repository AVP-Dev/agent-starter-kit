...
Готовый стартовый набор инженерных правил, архитектурной документации и автоматических протоколов для разработки проектов с участием автономных кодинг-агентов:
- **Gemini Antigravity** (нативный мастер-стандарт через `AGENTS.md`)
- **Claude Code** (симлинк `CLAUDE.md -> AGENTS.md`)
- **OpenAI Codex / GitHub Copilot** (симлинк `.github/copilot-instructions.md -> AGENTS.md`)
...
Вы открыли новый проект или существующий монорепозиторий в вашем редакторе/терминале. Просто отправьте агенту (Antigravity, Claude, Codex) сообщение:
